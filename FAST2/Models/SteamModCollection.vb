...
Namespace Models
    ...
    Public Class SteamModCollection
        <XmlElement(Order:=1)>
        Public Property CollectionName As String = "AppSteamMods"

        <XmlElement(Order:=2, ElementName:="SteamMod")>
        Public SteamMods As List(Of SteamMod) = New List(Of SteamMod)()

        Public Shared Function GetSteamMods() As SteamModCollection
            Dim currentSteamMods As New SteamModCollection

            If My.Settings.SteamModsCollection IsNot Nothing Then
                currentSteamMods = My.Settings.SteamModsCollection
            End If
                ...
                If Not duplicate Then
                    Try
                        ...
                        If modInfo IsNot Nothing Then
                            ...
                            My.Settings.SteamModsCollection = currentMods
                            My.Settings.Save()
                        Else
        ...
        Public Shared Sub UpdateInfoFromSteam()
            If My.Settings.SteamModsCollection.SteamMods.Count > 0 Then
                Dim currentMods = My.Settings.SteamModsCollection
                ...
                For Each steamMod In My.Settings.SteamModsCollection.SteamMods
                    If Not steamMod.PrivateMod Then
                        ...
                        If modInfo IsNot Nothing Then
                            Dim updateMod = currentMods.SteamMods.Find(Function(c) c.WorkshopId = steamMod.WorkshopId)
        ...
        Public Shared Sub DeleteSteamMod(workshopId As String)
            Dim currentSteamMods = GetSteamMods()

            currentSteamMods.SteamMods.RemoveAll(Function(x) x.WorkshopId = workshopId)

            My.Settings.Save()
        End Sub

        Public Shared Function SteamIdFromUrl(modUrl As String)
        ...
        Public Shared Function GetModInfo(modId) As Tuple(Of String, String, String)
    ...
    Public Class SteamMod
        ...
        Public Sub New(workshopId As Long, name As String, author As String, steamLastUpdated As Int32, Optional privateMod As Boolean = False)
